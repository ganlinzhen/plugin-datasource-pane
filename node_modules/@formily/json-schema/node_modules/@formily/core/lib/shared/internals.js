...
var allowAssignDefaultValue = function (target, source) {
    ...
    var isEmptyTarget = target !== null && (0, shared_1.isEmpty)(target);
    var isEmptySource = source !== null && (0, shared_1.isEmpty)(source);
    if (isEmptyTarget) {
